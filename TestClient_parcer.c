...
main(int argc, char* argv[])
{
    ...
    pipeline = gst_parse_launch("udpsrc port=10000 ! application/x-rtp,encoding-name=H264 ! rtpjitterbuffer ! rtph264depay ! avdec_h264 ! videoconvert ! autovideosink", &error);
    if (!pipeline) {
